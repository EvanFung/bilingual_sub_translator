...
def translate_text(text, translator, target_language='ZH'):
    # Using DeepL Translator for translation
    result = translator.translate_text(text, target_lang=target_language)
    return result.text

def process_srt(file_path, translator):
    translated_srt = []
...
def process_folder(folder_path, translator):
    ...
    for file in tqdm(srt_files, desc="Translating files", unit="file"):
        ...
        process_srt(file_path, translator)
...
process_folder(folder_path, translator)
